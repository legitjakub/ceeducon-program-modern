...
Plugin z těchto hodnot automaticky vytvoří datumové popisky, odkazy pro Google a Outlook Calendar, SEO Event structured data a roční údaje v Hero sekcích. Stejné hodnoty se použijí ve fallback šablonách, Gutenbergu i CEEDUCON Elementor widgetech.
...
Datum, místo, registrace, kalendářové odkazy a hlavní fotografie jsou v Hero bloku záměrně uzamčené a odkazují na centrální formulář. Tím nemohou mít Gutenberg, Elementor a PHP fallback rozdílné hodnoty.
