          ...
          <div class="floorplan" data-floorplan data-reveal>
            ...
            <div class="floorplan-stage">
              <figure class="floorplan-figure" data-level-plan="0">
                <img src="<?php echo esc_url(ceeducon_asset_url('assets/media/o2-plan-level-0.webp')); ?>" width="1448" height="1086" loading="lazy" decoding="async" alt="Plan of the O2 universum entrance level: main entrance, arena, meeting hub and halls B1 to B3." />
                <svg class="floorplan-hotspots" viewBox="0 0 100 100" preserveAspectRatio="none" aria-label="CEEDUCON halls on the entrance level">
                  <a class="vp-room" href="<?php echo esc_url(ceeducon_page_url('programme') . '?room=' . rawurlencode('B3')); ?>" data-room="B3"><title>Hall B3 — 8 sessions</title><rect x="80.52" y="37.02" width="14.02" height="9.76" vector-effect="non-scaling-stroke" /></a>
                  <a class="vp-room" href="<?php echo esc_url(ceeducon_page_url('programme') . '?room=' . rawurlencode('B2')); ?>" data-room="B2"><title>Hall B2 — 10 sessions</title><rect x="80.52" y="47.05" width="16.92" height="15.10" vector-effect="non-scaling-stroke" /></a>
                  <a class="vp-room" href="<?php echo esc_url(ceeducon_page_url('programme') . '?room=' . rawurlencode('B1')); ?>" data-room="B1"><title>Hall B1 — 10 sessions</title><rect x="80.46" y="62.43" width="16.99" height="16.21" vector-effect="non-scaling-stroke" /></a>
                </svg>
              ...
              <figure class="floorplan-figure" data-level-plan="1" hidden>
                ...
                <svg class="floorplan-hotspots" viewBox="0 0 100 100" preserveAspectRatio="none" aria-label="CEEDUCON halls on the conference level">
                  <a class="vp-room" href="<?php echo esc_url(ceeducon_page_url('programme') . '?room=' . rawurlencode('C3')); ?>" data-room="C3"><title>Hall C3 — 8 sessions</title><rect x="1.30" y="10.50" width="15.32" height="17.51" vector-effect="non-scaling-stroke" /></a>
                  <a class="vp-room" href="<?php echo esc_url(ceeducon_page_url('programme') . '?room=' . rawurlencode('C2')); ?>" data-room="C2"><title>Hall C2 — 8 sessions</title><rect x="1.30" y="28.53" width="15.32" height="10.92" vector-effect="non-scaling-stroke" /></a>
                  <a class="vp-room" href="<?php echo esc_url(ceeducon_page_url('programme') . '?room=' . rawurlencode('C1')); ?>" data-room="C1"><title>Hall C1 — 8 sessions</title><rect x="1.30" y="39.86" width="15.32" height="17.82" vector-effect="non-scaling-stroke" /></a>
                  <a class="vp-room" href="<?php echo esc_url(ceeducon_page_url('programme') . '?room=' . rawurlencode('D2')); ?>" data-room="D2"><title>Hall D2 — 8 sessions</title><rect x="53.49" y="40.37" width="8.52" height="5.46" vector-effect="non-scaling-stroke" /></a>
                  <a class="vp-room" href="<?php echo esc_url(ceeducon_page_url('programme') . '?room=' . rawurlencode('D3+D4')); ?>" data-room="D3+D4"><title>Hall D3+D4 — 8 sessions</title><rect x="62.45" y="40.16" width="12.35" height="16.79" vector-effect="non-scaling-stroke" /></a>
                  <a class="vp-room" href="<?php echo esc_url(ceeducon_page_url('programme') . '?room=' . rawurlencode('D6+D7')); ?>" data-room="D6+D7"><title>Hall D6+D7 — 8 sessions</title><rect x="62.51" y="64.78" width="10.56" height="15.24" vector-effect="non-scaling-stroke" /></a>
                </svg>
