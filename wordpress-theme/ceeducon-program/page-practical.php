            ...
            <div class="floorplan-stage">
              <figure class="floorplan-figure" data-level-plan="0">
                ...
                <svg class="floorplan-hotspots" viewBox="0 0 100 100" preserveAspectRatio="none" aria-label="CEEDUCON halls on the entrance level">
                  <a class="vp-room" href="<?php echo esc_url(ceeducon_page_url('programme') . '?room=' . rawurlencode('B3')); ?>" data-room="B3"><title>Hall B3 — 8 sessions</title><rect class="vp-hit" x="80.94" y="13.20" width="14.16" height="20.55" /><rect x="80.94" y="21.08" width="14.16" height="12.67" vector-effect="non-scaling-stroke" /></a>
                  <a class="vp-room" href="<?php echo esc_url(ceeducon_page_url('programme') . '?room=' . rawurlencode('B2')); ?>" data-room="B2"><title>Hall B2 — 10 sessions</title><rect class="vp-hit" x="80.94" y="33.18" width="17.06" height="20.39" /><rect x="80.94" y="33.18" width="17.06" height="20.05" vector-effect="non-scaling-stroke" /></a>
                  <a class="vp-room" href="<?php echo esc_url(ceeducon_page_url('programme') . '?room=' . rawurlencode('B1')); ?>" data-room="B1"><title>Hall B1 — 10 sessions</title><rect class="vp-hit" x="80.87" y="53.57" width="17.13" height="20.39" /><rect x="80.87" y="53.57" width="17.13" height="20.39" vector-effect="non-scaling-stroke" /></a>
                </svg>
