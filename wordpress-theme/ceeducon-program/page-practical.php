            ...
            <div class="floorplan-stage">
              <figure class="floorplan-figure" data-level-plan="0">
                ...
                <svg class="floorplan-hotspots" viewBox="0 0 100 100" preserveAspectRatio="none" aria-label="CEEDUCON halls on the entrance level">
                  <a class="vp-room" href="<?php echo esc_url(ceeducon_page_url('programme') . '?room=' . rawurlencode('B3')); ?>" data-room="B3"><title>Hall B3 — 8 sessions</title><rect class="vp-hit" x="80.52" y="29.45" width="14.02" height="17.46" /><rect x="80.52" y="37.02" width="14.02" height="9.76" vector-effect="non-scaling-stroke" /></a>
                  <a class="vp-room" href="<?php echo esc_url(ceeducon_page_url('programme') . '?room=' . rawurlencode('B2')); ?>" data-room="B2"><title>Hall B2 — 10 sessions</title><rect class="vp-hit" x="80.52" y="46.91" width="16.92" height="15.37" /><rect x="80.52" y="47.05" width="16.92" height="15.10" vector-effect="non-scaling-stroke" /></a>
                  <a class="vp-room" href="<?php echo esc_url(ceeducon_page_url('programme') . '?room=' . rawurlencode('B1')); ?>" data-room="B1"><title>Hall B1 — 10 sessions</title><rect class="vp-hit" x="80.46" y="62.41" width="16.99" height="17.46" /><rect x="80.46" y="62.43" width="16.99" height="16.21" vector-effect="non-scaling-stroke" /></a>
                </svg>
