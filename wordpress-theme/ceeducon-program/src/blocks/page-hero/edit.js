(function (blocks, element, blockEditor, components, i18n) {
  ...
  blocks.registerBlockType("ceeducon/page-hero", {
    edit({ attributes, setAttributes }) {
      return el(
        "section",
        { className: `page-hero ceeducon-editor-block ${attributes.orange ? "page-hero--orange" : ""}` },
        el(
          InspectorControls,
          {},
          el(
            ...
            el(ToggleControl, { label: __("Oranžový akcent", "ceeducon-program"), checked: attributes.orange, onChange: (orange) => setAttributes({ orange }) }),
