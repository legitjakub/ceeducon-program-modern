...
function ceeducon_admin_content_fields(): array
{
    return [
        ...
        'Programme page' => [
            ...
            ['archive_label', 'Programme notice label', 'Preliminary', 'text'],
            ['archive_text', 'Programme notice text', 'This is the preliminary CEEDUCON 2026 programme and it remains subject to change. Some speakers are still being confirmed and are marked “tbc”.', 'textarea'],
