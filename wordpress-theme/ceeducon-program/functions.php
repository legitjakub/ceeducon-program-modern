...
function ceeducon_admin_content_fields(): array
{
    return [
        ...
        'Home — hero' => [
            ...
            ['event_calendar_label', 'Other calendars button', 'Apple · Outlook · .ics', 'text'],
            ['event_calendar_url', 'ICS calendar file URL', ceeducon_asset_url('assets/ceeducon-2026.ics'), 'url'],
